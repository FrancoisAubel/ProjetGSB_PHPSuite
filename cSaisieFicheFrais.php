 ...
 */
  ...
  // teste si la fiche est déja validée ou cloturée
  $etat = obtenirEtatFicheFrais($idConnexion, $mois, obtenirIdUserConnecte());
  $etat = $etat["idEtat"];
if ($etat == "VA" || $etat == "CL")
{
    ?> <p> La fiche est déja validée. Merci d'attendre le prochain mois pour en créer une nouvelle.</p> <?php
}
    else //sinon, on traite normalement la page
{
